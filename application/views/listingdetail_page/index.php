                        ...
                        <div class="container">
                            <div class="reviewer-info d-flex flex-wrap align-items-center w-100">
                                <div class="reviewer-info-img">
                                    <img class="img-fluid rounded-circle" src="<?= base_url('assets/images/resources/reviewer-img2.jpg') ?>" alt="Reviewer Image 2">
                                            ...
                                            <div class="place-layout-detail-gal w-100">
                                                <div class="row mrg10">
                                                    <div class="col-md-4 col-sm-4 col-sm-4">
                                                        <a href="assets/images/resources/place-layout-detail-gal-img1-1.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-layout-detail-gal-img1-1.jpg') ?>" alt="Place Layout Detail Gallery Image 1"></a>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-sm-4">
                                                        <a href="assets/images/resources/place-layout-detail-gal-img1-2.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-layout-detail-gal-img1-2.jpg') ?>" alt="Place Layout Detail Gallery Image 2"></a>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-sm-4">
                                                        <a href="assets/images/resources/place-layout-detail-gal-img1-3.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-layout-detail-gal-img1-3.jpg" alt="Place Layout Detail Gallery Image 3') ?>"></a>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-sm-4">
                                                        <a href="assets/images/resources/place-layout-detail-gal-img1-4.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-layout-detail-gal-img1-4.jpg') ?>" alt="Place Layout Detail Gallery Image 4"></a>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-sm-4">
                                                        <a href="assets/images/resources/place-layout-detail-gal-img1-5.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-layout-detail-gal-img1-5.jpg') ?>" alt="Place Layout Detail Gallery Image 5"></a>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-sm-4">
                                                        <a href="assets/images/resources/place-layout-detail-gal-img1-6.jpg" data-fancybox="gallery" title=""><img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-layout-detail-gal-img1-6.jpg') ?>" alt="Place Layout Detail Gallery Image 6"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="place-layout-detail-inner2 w-100" id="video">
                                        ...
                                        <div class="place-layout-detail-content-inner w-100">
                                            <div class="place-video w-100 position-relative">
                                                ...
                                                <img class="img-fluid w-100" src="<?= base_url('assets/images/resources/place-video-img.jpg') ?>" alt="Place Video Image">
                                            </div>
                                        </div>
                                    </div>
