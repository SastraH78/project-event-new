...
<div class="subscribe-popup-wrap w-100 text-center position-fixed h-100">
    <div class="subscribe-popup-inner d-block overflow-hidden brd-rd20">
        <div class="subscribe-popup-iner w-100 brd-rd20 overflow-hidden" style="background-image: url(assets/images/popup-top-bg.png);">
            <span class="popup-cls-btn rounded-circle"><i class="fa fa-times"></i></span>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-sm-6 col-lg-6">
                    <div class="social-links2 d-inline-block">
                        ...
                        <a href="javascript:void(0);" title="Twitter" target="_blank"><i class="fab fa-twitter"></i></a>
                        <a href="javascript:void(0);" title="Linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                        <a href="javascript:void(0);" title="Behance" target="_blank"><i class="fab fa-behance"></i></a>
                        <a href="javascript:void(0);" title="Pinterest" target="_blank"><i class="fab fa-pinterest-p"></i></a>
